...
export const patientManagementContent: BlogContent = {
  intro: "Choosing the right patient management system is crucial for the success of any virtual care platform. A well-designed system can streamline operations, improve patient engagement, and enhance the overall quality of care. Here’s what to consider when selecting a patient management system for your virtual care platform.",
  ...
  conclusion: "Selecting the right patient management system can transform the way you deliver virtual care, making your practice more efficient and patient-centric. By focusing on integration, security, user-friendliness, scalability, and virtual care features, you're investing in the future of your practice."
};