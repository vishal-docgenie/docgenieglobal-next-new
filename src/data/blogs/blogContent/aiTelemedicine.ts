...
export const aiTelemedicineContent: BlogContent = {
  ...
  sections: [
    {
      id: 'revolutionizing-diagnosis-with-ai-powered-tools',
    ...
    {
      id: 'enhancing-patient-engagement-with-ai-voice-and-chatbots',
    ...
    {
      id: 'streamlining-clinical-documentation-with-aws-healthscribe',
    ...
    {
      id: 'innovative-integration-with-the-cims-database',
    ...
    {
      id: 'our-commitment-to-ai-powered-healthcare',
