...
export const telemedicinePlatformContent: BlogContent = {
  ...
  sections: [
    ...
    {
      id: 'beyond-video-comprehensive-digital-healthcare-solutions',
    ...
    {
      id: 'the-business-case-for-comprehensive-telemedicine-solutions',
