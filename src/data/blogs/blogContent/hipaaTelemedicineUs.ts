...
export const hipaaTelemedicineUsContent: BlogContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `The HIPAA Security Rule's technical safeguards are particularly relevant to telehealth platforms. When evaluating a vendor, ask specifically how it addresses each, and note which underlying specifications are "required" and which are "addressable":
